<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Adminmst.Master" AutoEventWireup="true" CodeBehind="ClassFees.aspx.cs" Inherits="InstituteManagementSystemCsharp.net.Admin.ClassFees" %>
              ...
              <div class="row mb-3 mr-lg-5 ml-lg-5 ">
                 <div class="col-md-6">
                     <asp:GridView ID="GridView1" runat="server" CssClass="table table-hover table-bordered" EmptyDataText="No Record To Display!" AutoGenerateColumns="False" 
                         ...
                         OnRowUpdating="GridView1_RowUpdating" AllowPaging="true" PageSize="5" DataKeyNames="FeesId">
                         <Columns>
