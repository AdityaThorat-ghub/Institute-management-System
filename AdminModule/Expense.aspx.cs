    ...
    public partial class Expense : System.Web.UI.Page
    {
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string chargeAmt = txtExpenceAmt.Text.Trim();
                ...
                if (dt.Rows.Count == 0)
                {
                    ...
                    txtExpenceAmt.Text = string.Empty;
                    GetExpense();
                }

                else
                {
                    lblMsg.Text = "Entered <b>Data Already Exists!</b> Already Exists !";
        ...
        protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            try
            {
                ...
                string chargeAmt = (row.FindControl("txtExpenceAmt") as TextBox).Text.Trim();
