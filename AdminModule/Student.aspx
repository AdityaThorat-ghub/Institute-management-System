<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Adminmst.Master" AutoEventWireup="true" CodeBehind="Student.aspx.cs" Inherits="InstituteManagementSystemCsharp.net.Admin.Student" %>
             ...
             <div class="row mb-3 mr-lg-5 ml-lg-5 mt-md-5">
              ...
              <div class="row mb-3 mr-lg-5 ml-lg-5 mt-md-5">
               ...
               <div class="row mb-3 mr-lg-5 ml-lg-5 mt-md-5">
                 ...
                 <div class="col-md-6">
                    <label for="ddlClass" > Class Name </label>
              ...
              <div class="row mb-3 mr-lg-5 ml-lg-5 ">
                 <div class="col-md-12">
                     <asp:GridView ID="GridView1" runat="server" CssClass="table table-hover table-bordered" EmptyDataText="No Record To Display!" AutoGenerateColumns="False" 
                         ...
                         OnRowUpdating="GridView1_RowUpdating" AllowPaging="True" PageSize="5" DataKeyNames="StudentId" OnRowDataBound="GridView1_RowDataBound" >
                         <Columns>
