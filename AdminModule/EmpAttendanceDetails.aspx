<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Adminmst.Master" AutoEventWireup="true" CodeBehind="EmpAttendanceDetails.aspx.cs" Inherits="InstituteManagementSystemCsharp.net.Admin.EmpAttendanceDetails" %>
             ...
             <div class="row mb-3 mr-lg-5 ml-lg-5 mt-md-5">
                 ...
                 <div class="col-md-6">
                    <label for="ddlSubject" > Month </label>
                     <asp:TextBox ID="txtMonth" runat="server" CssClass="form-control" required TextMode="Month" ></asp:TextBox>
                 </div>
                 ...
                 <div class="col-md-12">
                      <asp:GridView ID="GridView1" runat="server" CssClass="table table-hover table-bordered" EmptyDataText="No Record To Display!" AutoGenerateColumns="False"  >
                         <Columns>
                             ...
                             <%-- <asp:BoundField DataField="ststus" HeaderText="Status">
                             <ItemStyle HorizontalAlign="Center" />
                             </asp:BoundField>--%>

                             <asp:TemplateField HeaderText="Status">
                                 <ItemTemplate>
                                     <asp:Label runat="server" ID="label1" Text='<%# Boolean.Parse(Eval("ststus").ToString()) ?"Present" : "Absent" %>'>
